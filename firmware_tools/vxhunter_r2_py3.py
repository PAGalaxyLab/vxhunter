...
symbol_format_sign_5 = [
    b'\x00\x00\x05\x00',  # Function
    b'\x00\x00\x07\x00',  # Variable
    b'\x00\x00\x09\x00',  # Variable
    b'\x00\x00\x11\x00'   #
]

symbol_format_sign_6 = [
    b'\x00\x00\x00\x00\x00\x00\x03\x00',  # Unknown Type (Might not function name)
    b'\x00\x00\x00\x00\x00\x00\x05\x00',  # Function
    b'\x00\x00\x00\x00\x00\x00\x07\x00',  # Variable
    b'\x00\x00\x00\x00\x00\x00\x09\x00',  # Variable
    b'\x00\x00\x00\x00\x00\x00\x11\x00'
]
